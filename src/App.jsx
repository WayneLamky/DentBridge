...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-neutral-700">
      ...
      {/* Hero — Sticky base layer */}
      <section className="sticky top-0 z-10 min-h-screen flex items-center justify-center bg-black">
      ...
      {/* Destination Comparison — Slides over Hero */}
      <section id="destinations" className="sticky top-0 z-20 bg-[#F4F4F5] text-black rounded-t-[3rem] px-6 py-32 -mt-16 scroll-mt-24">
      ...
      {/* Route Assessment — Slides over Destinations */}
      <section id="assessment" className="sticky top-0 z-30 bg-white rounded-t-[3rem] px-6 py-32 -mt-20 scroll-mt-24">
      ...
      {/* Cases & FAQ — Slides over Assessment */}
      <section id="cases" className="sticky top-0 z-40 bg-black text-white rounded-t-[3rem] px-6 py-32 -mt-20 scroll-mt-24">
        <div className="max-w-7xl mx-auto">
      ...
      {/* Footer — final layer */}
      <footer className="relative z-50 bg-black text-neutral-500 py-16 px-6 border-t border-neutral-900">
